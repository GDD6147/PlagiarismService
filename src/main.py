...
from src.models import CheckRequest, CheckResponse, Match, MethodResult
from src.plagiarism import detect_language, compare_codes_with_methods
...
CHECK_TIMEOUT_SECONDS = int(os.getenv("MAX_CONCURRENT_CHECKS", 30))
